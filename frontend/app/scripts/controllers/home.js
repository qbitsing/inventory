...
.controller('HomeCtrl', function ($scope) {
    ...
    $scope.crearLlaveUsuario=function(){
    	if ($scope.conexion) {
            $scope.operacion='8';
    		sendRequest({"cmd":"createuserkey","data":{"syscode":"36363636","regcode":"31313131","id":12,"groupid":333,"beep":true,"timezonelist":[{"id":1,"count":"1","list":[{"id":1,"begin":"0001","end":"2359","mo":0,"tu":0,"we":0,"th":1,"fr":1,"sa":0,"su":0,"h":0,"s1":0,"s2":0}]}],"calendaryear":"2017","activationtime":"1706291832","expirytime":"1906291832","addplanlist":[{"id":25,"type":"lock","timezoneid":1},{"id":26,"type":"lock","timezoneid":1}]}});
    	}else{
            sweetAlert("Oops...", "No se ha podido hacer conectar con el socket" , "error");
        }
    }
